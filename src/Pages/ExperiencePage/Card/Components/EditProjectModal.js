            ...
            <Modal>
                <ModalContentDiv>
                    ...
                    <ModalProjectTitle>
                        ...
                        <ModalProjectTitleInput name="name" onChange={userInputHandler} placeholder="15자 이내로 입력해주세요." defaultValue={propsProjectData?.name}>
...
const ModalProjectImageUploadInner = styled.div`
width: 306px;
height: 40px;
/* border: 1px solid black; */
flex-direction: row;
...
const ModalProjectImageNameDiv2 = styled.div`
width: 236px;
height: 18px;
flex-direction: row;
/* border: 1px solid black; */
...
const ModalProjectPreviousImage = styled.div`
width: 236px;
height: 18px;
flex-direction: row;
/* border: 1px solid black; */
